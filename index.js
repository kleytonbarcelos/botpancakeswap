...
let questions = [{
    name: "token",
    type: "input",
    message: "Type the TOKEN to buy?",
},
{
    name: "bnb",
    type: "input",
    message: "Amount BNB to buy?",
}]
...
const data = {
  ...
  to_PURCHASE: answers.token, // token that you will purchase = BUSD for test '0xe9e7cea3dedca5984780bafc599bd69add087d56'

  AMOUNT_OF_BNB : answers.bnb, //process.env.AMOUNT_OF_BNB, // how much you want to buy in BNB
